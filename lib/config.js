...
const SUPPORTED_APPS = [
  ...
  { id: '6473753684', name: 'Claude', developer: 'Anthropic', bg: 'from-orange-400 to-red-500', tag: 'AI TOOL' },
  { id: '6477489729', name: 'Gemini', developer: 'Google', bg: 'from-blue-400 to-purple-600', tag: 'AI TOOL' },
  { id: '544007664', name: 'YouTube', developer: 'Google', bg: 'from-red-500 to-red-700', tag: 'VIDEO' },
  { id: '363590051', name: 'Netflix', developer: 'Netflix', bg: 'from-gray-800 to-black', tag: 'STREAMING' },
  { id: '835599320', name: 'TikTok', developer: 'TikTok', bg: 'from-pink-500 to-black', tag: 'SOCIAL' }
];
